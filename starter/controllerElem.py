...
backward = (f_left_backward, f_right_backward, b_left_backward, b_right_backward)
right = (b_left_forward, b_right_forward, f_left_forward)
left = (b_left_forward, b_right_forward, f_right_forward)
...
class MyController(Controller):
    ...
    # Stop the car. What motor do we turn off?
